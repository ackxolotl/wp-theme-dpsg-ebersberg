...
?>
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'dpsg-ebersberg' ),
		...
		<nav id="comment-nav-above" class="comment-navigation" role="navigation">
			...
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'dpsg-ebersberg' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'dpsg-ebersberg' ) ); ?></div>
